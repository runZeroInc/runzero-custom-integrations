...
- Cardinality: one asset per host per report. The same physical host scanned by three tasks yields three report hosts, which is why they must converge by address rather than by id.
